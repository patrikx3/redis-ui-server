...
export default {
    ...
    ZINTERSTORE: 'destination numkeys key [key ...] [WEIGHTS weight ...] [AGGREGATE SUM|MIN|MAX|COUNT]',
    ZUNIONSTORE: 'destination numkeys key [key ...] [WEIGHTS weight ...] [AGGREGATE SUM|MIN|MAX|COUNT]',
    ZDIFFSTORE: 'destination numkeys key [key ...]',
    ZINTER: 'numkeys key [key ...] [WEIGHTS weight ...] [AGGREGATE SUM|MIN|MAX|COUNT] [WITHSCORES]',
    ZUNION: 'numkeys key [key ...] [WEIGHTS weight ...] [AGGREGATE SUM|MIN|MAX|COUNT] [WITHSCORES]',
    ...
    'TS.RANGE': 'key fromTimestamp toTimestamp [LATEST] [FILTER_BY_TS ts ...] [FILTER_BY_VALUE min max] [COUNT count] [AGGREGATION aggregator[,aggregator...] bucketDuration]',
    'TS.REVRANGE': 'key fromTimestamp toTimestamp [LATEST] [FILTER_BY_TS ts ...] [FILTER_BY_VALUE min max] [COUNT count] [AGGREGATION aggregator[,aggregator...] bucketDuration]',
    'TS.MRANGE': 'fromTimestamp toTimestamp [LATEST] [FILTER_BY_TS ts ...] [FILTER_BY_VALUE min max] [WITHLABELS] [COUNT count] [AGGREGATION aggregator[,aggregator...] bucketDuration] FILTER filter ...',
    'TS.MREVRANGE': 'fromTimestamp toTimestamp [LATEST] [FILTER_BY_TS ts ...] [FILTER_BY_VALUE min max] [WITHLABELS] [COUNT count] [AGGREGATION aggregator[,aggregator...] bucketDuration] FILTER filter ...',
    'TS.GET': 'key [LATEST]',
    ...
    'ARNEXT': 'key',
    'ARSEEK': 'key index',
    'AROP': 'key operation start end',
    'ARGREP': 'key predicate start end',
    'ARINFO': 'key [FULL]',

    // Other Redis 8.8 commands
    'INCREX': 'key [BYINT increment | BYFLOAT increment] [LBOUND min] [UBOUND max] [SATURATE] [EX seconds | PX ms | EXAT ts | PXAT ts | PERSIST] [ENX]',
